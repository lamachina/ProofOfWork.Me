...
![PowID n squared network potential](powid-n2-linear.png)

![Modeled PowID value density](powid-value-density-linear.png)

![PowID future value scenarios](powid-future-value-linear.png)
